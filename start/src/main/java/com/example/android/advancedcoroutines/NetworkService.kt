...
class NetworkService {
    ...
    private val retrofit = Retrofit.Builder()
        .baseUrl("https://raw.githubusercontent.com/android/codelab-kotlin-coroutines/master/")
        .client(OkHttpClient())
...
interface SunflowerService {
    @GET("advanced-coroutines-codelab/sunflower/src/main/assets/plants.json")
    suspend fun getAllPlants() : List<Plant>

    @GET("advanced-coroutines-codelab/sunflower/src/main/assets/custom_plant_sort_order.json")
